        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="<?= (in_array($modulo, ['departamentos', 'produtos', 'anuncios']) ? 'active' : ''); ?>">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="?m=produtos_destaque">
                            <i class="fa fa-barcode fa-fw"></i> Produtos em destaque
                        </a>
                    </li>
                    <li>
                        <a href="?m=produtos_novos">
                            <i class="fa fa-barcode fa-fw"></i> Produtos novos
                        </a>
                    </li>
                    <li>
                        <a href="?m=anuncios">
