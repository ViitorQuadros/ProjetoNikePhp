<?php
    ...
    $query = mysqli_query($db, "SELECT * FROM cadastro_produtos" . (!empty($busca) ? " WHERE ({$search})" : '') . " ORDER BY nome ASC LIMIT {$inicio}, {$limite}");
?>
...
<div class="row">
	<div class="col-lg-12">
                    ...
                    if (mysqli_num_rows($query)) {
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?= (!empty($item['nome']) ? $item['nome'] : '') . (!empty($item['marca']) ? " <small>| Ref.: {$item['marca']}" : ''); ?>
                                </td>
                                <td style="width: 15%;">
        ...
        <?php
            ...
            $query = mysqli_query($db, "SELECT count(*) AS cont FROM cadastro_produtos" . (!empty($busca) ? " WHERE ({$search})" : ''));
            if ($query) {
