<?php
    ...
    $query = mysqli_query($db, "SELECT * FROM produtos_destaque" . (!empty($busca) ? " WHERE ({$search})" : '') . " ORDER BY nome ASC LIMIT {$inicio}, {$limite}");
?>
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Produtos em destaque</h3>
    </div>
</div>
